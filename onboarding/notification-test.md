...
**On send:** flow continues directly to the next onboarding step (onboarding complete) regardless of whether the learner reacts to this message. No response is required or expected.
