...
## Onboarding flow — now fully locked end to end

1. `/start` — welcome-message.md (LDTKB-031)
2. Gender question — gender-question.md (LDTKB-033)
3. Schedule selection — schedule-selection.md (LDTKB-034)
4. Notification test — notification-test.md (LDTKB-035)
5. Onboarding complete — this file (LDTKB-036)
6. First lesson delivered per curriculum/pilot/
