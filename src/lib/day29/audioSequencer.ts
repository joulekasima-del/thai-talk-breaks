...
//
// Timing rule, per day29-living-comic-spec.md ("Audio timing", halved per
// LDTKB-056):
//   - 1 second between individual speeches within the same panel
//   - 2 seconds between panels (and, by the same stated rule, between pages —
...
//     visible" rule, so the 2s pages case never actually applies within a
//     single page's plan).
//
...
export const SPEECH_GAP_MS = 1000;
export const PANEL_GAP_MS = 2000;
