// Locked /oops copy — given verbatim by Joule, not sourced from an
// onboarding/*.md file (this is its own feature, independent of onboarding),
// so it gets its own content module rather than folding into
