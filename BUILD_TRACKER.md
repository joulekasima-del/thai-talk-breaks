...
| Day 29 story + 8-page illustration | 🟡 7 of 8 pages confirmed correct; **Page 2 needs regenerating** — Panel 2's "dâi-kâ" (female particle) contradicts the illustrated male barista, confirmed 21 Aug 2026; corrected text is "dâi-kráp," see `day29-illustration-prompts.md` |
| Day 29 narration audio | 🟡 Partial — **5 of 8 pages have any audio file** (01, 02, 05, 06, 08); Pages 3, 4, 7 have zero. Confirmed missing (flagged by `day29-page5-new-audio.md`, never produced): `day29_page05_panel1_dtom.mp3`. **Resolved 21 Aug 2026:** Page 2 panel 1's two bubbles are separate lines by design (Firefly text-rendering split, per `day29-illustration-prompts.md` Notes) — bubble 1 ("ao-gaa-fae-yen-nèung-gâew-kâ") reuses `week2_day13_female.mp3` exactly, no new recording needed; bubble 2 ("wǎan-nói-ná-ká") has no existing audio and needs a fresh recording. Page 2 panel 2's existing audio file (if any) needs regenerating in a **male** voice reading "ได้ครับ" (dâi-kráp), not the old female "ได้ค่ะ." **Still unclear, needs Joule's confirmation, not assumed:** whether Page 1 panels 1–2 intentionally reuse existing pilot/Week 2 audio. `day29_page08_panel2.mp3` also exists despite `day29-story-draft.md`'s Page 8 section describing only a single "Panel 1" — naming inconsistency, unresolved. Per `day29-page5-new-audio.md`'s own note, reuse-vs-new status was only ever checked for Page 5, not the other 7 pages. |
