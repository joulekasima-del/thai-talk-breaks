...
| Day 29 story + 8-page illustration | ✅ 8 of 8 pages confirmed correct — Page 2 regenerated 22 Aug 2026 with corrected "dâi-kráp" text, vertical layout, no invented Thai script/title. Assets now live in `curriculum/day29/assets/` (consolidated 22 Aug 2026, see below) |
| Day 29 narration audio | ✅ **Complete 22 August 2026 — all 20 dialogue lines have a dedicated recording.** (Previous status here had a stale count, "8 of 18"/"10 of 18" — corrected same day to the real total of 21 lines before the remaining 12 were recorded and added, bringing the total to 20 after Page 2's two-bubble lines were combined into one.) Page 8's audio file naming fix (`panel2`→`panel1`), previously reported done but never actually pushed, is now genuinely fixed. **All Day 29 assets (images + audio) consolidated into one folder, `curriculum/day29/assets/`**, replacing the previous separate `images/`/`audio/` folders — see `day29-audio-map.md` for the full file list. |
