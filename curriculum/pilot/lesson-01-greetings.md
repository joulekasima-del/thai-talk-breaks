# Lesson 1 of 7 — Greetings & Basic Politeness
...
| Speaker voice | Karaoke | Tone pattern (per LDTKB-025) |
|---|---|---|
| Male | **sà-wàt-dii kráp** | low – low – mid – high |
| Female | **sà-wàt-dii kâ** | low – low – mid – falling |

**Tone legend** (shown once, early in onboarding — per LDTKB-025):
...
### Step 4 — Thai script (decorative/reference only — not tested, per LDTKB-006 and CLAUDE_AI_HANDOFF.md Section 4)
...
- This is lesson 1 of the 7-day free pilot; arc order and rationale documented in BUILD_TRACKER.md Stage 3 discussion (numbers-before-transactional-lessons sequencing).
- Wai gesture chosen deliberately for the image — reinforces that this is a real spoken/social interaction, not just vocabulary.
